...
public class StringHelper {
     ...
     * @param length Integer 指定长度
     * @return String 返回的字符串
     */
    public static String toLength(String str, Integer length) {
        if (str == null) {
            return null;
        }
        if (length <= 0) {
    ...
    public static boolean isint(String str) {
        Pattern pattern = ValidateHelper.compile("^[-\\+]?[\\d]+$");
    ...
    public static boolean isDouble(String str) {
        Pattern pattern = ValidateHelper.compile("^[-\\+]?\\d+\\.\\d+$");
        return pattern.matcher(str).matches();
    }
    ...
    public static boolean isLetter(String str) {
        ...
        Pattern pattern = ValidateHelper.compile("[\\w\\.-_]*");
        return pattern.matcher(str).matches();
    }
    ...
    public static boolean isEmail(String email) {
        ...
        Pattern pattern = ValidateHelper
                .compile("^\\w+([-+.]\\w+)*@\\w+([-.]\\w+)*\\.\\w+([-.]\\w+)*$");
    ...
    public static boolean isChinese(String str) {
        Pattern pattern = ValidateHelper.compile("[\u0391-\uFFE5]+$");
        return pattern.matcher(str).matches();
    }
    ...
    public static String hangeToBig(String str) {
        ...
        for (Integer i = 0; i < chDig.length; i++) { // 循环处理每个数字
    ...
    public static String encoding(String src) {
        ...
        if (src != null) {
            src = src.trim();
            for (Integer pos = 0; pos < src.length(); pos++) {
    ...
    public static void main(String[] args) {
        ...
        // //System.out.println("判断是否为整数：" + isint("+0"));
        ...
        // //System.out.println("人民币转换成大写：" + hangeToBig("10019658")); //System.out.println("去掉字符串中重复的子字符串：" + removeSameString("100 100 9658"));
     ...
     * @return
     */
    public static String replaceWithSpecialChar(String mobile) {
    ...
    public static String clearHtml(String htmlStr) {
        ...
        try {
            ...
            str = htmlStr.replaceAll("</?[^>]+>", ""); //剔出<html>的标签
     ...
     * @return
     */
    public static String clearHtmlStyle(String htmlStr) {

        String str = "";

        try {

            str = htmlStr.replaceAll(" style=\"(.*?)\"", ""); //剔出<html>的标签
     ...
     * @return
     */
    public static String subString(String s, Integer start, Integer length) {
     ...
     * @return
     */
    public static String getChineseSubString(String str, Integer length) {
        int count = 0;
        int offset = 0;
     ...
     * @return
     */
    public static String getStringTitle(String str, Integer length) {

        str = clearHtmlStyle(str);

        return getChineseSubString(str, length);

    }

    public static String chaToString(char[] password) {
