...
public class CryptHelper {  
     ...
     * @return 
     */  
    public Object getObjFromFile(String file, Integer i) {  
    ...
    public String encryptToDES(String info){
    	SecretKey key = this.createSecretKey("DES");
    	return this.encryptToDES(key, info);
    }
    public String decryptToDES(String info){
    	SecretKey key = this.createSecretKey("DES");
    	return this.decryptByDES(key, info);
    }
    /** 
     * 测试 
     *  
