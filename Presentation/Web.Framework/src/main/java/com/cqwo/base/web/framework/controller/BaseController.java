...
import com.cqwo.base.core.helper.DateHelper;
import com.cqwo.base.core.helper.StringHelper;
import com.cqwo.base.core.helper.TypeHelper;
import com.cqwo.base.services.*;
import com.cqwo.base.web.framework.PromptModel;
import com.cqwo.base.web.framework.view.JsonView;
...
//    protected CWMUpload cwmUpload;
    ...
    protected String getPromptView() {
        return "prompt";
    }
     ...
     * @return 返回上下文
     */
    abstract IWorkContext getWorkContext();
    ...
    protected ModelAndView PromptView(String message) {
        ...
        return View(getPromptView(), new PromptModel(message, this.urlReferer));
    }
     ...
     * @return
     */
    protected ModelAndView PromptView(Integer error, String message) {

        return View(getPromptView(), new PromptModel(error, message, this.urlReferer));
    }
    ...
    protected ModelAndView PromptView(String message, Boolean isAutoBack) {
        ...
        return View(getPromptView(), new PromptModel(message, this.urlReferer, isAutoBack));
    }
    ...
    protected ModelAndView PromptView(String backUrl, String message) {
        return View(getPromptView(), new PromptModel(message, backUrl));
    }
    ...
    protected ModelAndView PromptView(String backUrl, String message, Boolean isAutoBack) {
        return View(getPromptView(), new PromptModel(message, backUrl, isAutoBack));
    }
    ...
    protected ModelAndView PromptView(String backUrl, String message, Integer countdowntime) {
        return View(getPromptView(), new PromptModel(message, backUrl, countdowntime));
    }
    ...
    protected ModelAndView PromptView(String backUrl, String message, Integer countdownmodel, Integer countdowntime, boolean isshowbacklink, boolean isautoback) {
        return View(getPromptView(), new PromptModel(message, backUrl, countdownmodel, countdowntime, isshowbacklink, isautoback));
    }
    ...
    public String JsonView(Integer state, Object content, String message) {
        ...
        return JsonView.view(state, JSON.toJSONString(content), message, response);
